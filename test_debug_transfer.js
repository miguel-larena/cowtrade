...
async function testDebugTransfer() {
  try {
    console.log('🧪 Testing Debug Transfer...\n');
    console.log('This will help us see the backend logs for the transfer issue\n');
    ...
    console.log('   This should trigger the transfer logic and show backend logs...\n');
    ...
    console.log('\n🔍 Check the backend terminal for detailed transfer logs!');
