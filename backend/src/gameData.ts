...
// Helper function to create starting hand for a player
export function createStartingHand(playerId: string): Card[] {
  return [
    { id: `money10_${playerId}_1`, type: 'money', value: 10, name: '10' },
    { id: `money10_${playerId}_2`, type: 'money', value: 10, name: '10' },
    { id: `money10_${playerId}_3`, type: 'money', value: 10, name: '10' },
    { id: `money10_${playerId}_4`, type: 'money', value: 10, name: '10' },
    { id: `money0_${playerId}_1`, type: 'money', value: 0, name: '0' },
    { id: `money0_${playerId}_2`, type: 'money', value: 0, name: '0' },
    { id: `money50_${playerId}_1`, type: 'money', value: 50, name: '50' }
  ];
}

// Helper function to create a new game state
export function createNewGameState(players: string[]): GameState {
  const gamePlayers: Player[] = players.map((name, index) => ({
    id: `player${index + 1}`,
    name,
    hand: createStartingHand(`player${index + 1}`),
    money: 90
  }));
